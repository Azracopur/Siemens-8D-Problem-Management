...
import { d as defineCustomElement$3 } from './p-DlVaL0Yi.js';
...
const ToastContainer = /*@__PURE__*/ proxyCustomElement(class ToastContainer extends H {
    ...
    async showToast(config) {
        ...
        if (config.action && config.action instanceof H) {
...
function defineCustomElement$1() {
    ...
    const components = ["ix-toast-container", "ix-icon-button", "ix-spinner", "ix-toast", "ix-typography"];
