...
const BreadcrumbItem = class {
    ...
    animationFadeIn() {
        anime_esm.animate(this.hostElement, {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: {
            ...
            }, onClick: () => this.itemClick.emit(this.label) }, index.h("li", null, index.h(baseButton.BaseButton, Object.assign({}, props, { afterContent: index.h(index.Fragment, null, !this.hideChevron && (index.h("ix-icon", { name: index$1.iconChevronRightSmall, size: "16", class: 'chevron' }))) }), this.label, index.h("slot", null)))));
    }
