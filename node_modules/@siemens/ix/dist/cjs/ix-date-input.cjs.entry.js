...
const DateInput = class {
    constructor(hostRef) {
        ...
        this.datepickerRef = makeRef.makeRef();
    ...
    async onInput(value) {
        ...
        const date = datetime.DateTime.fromFormat(value, this.format);
        const minDate = datetime.DateTime.fromFormat(this.minDate, this.format);
        const maxDate = datetime.DateTime.fromFormat(this.maxDate, this.format);
    ...
    renderInput() {
        ...
        return (index.h("div", { class: "input-wrapper" }, index.h(input_fc.SlotStart, { slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), index.h("input", { autoComplete: "off", class: {
            ...
            } }), index.h(input_fc.SlotEnd, { slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, index.h("ix-icon-button", { "data-testid": "open-calendar", class: { 'calendar-hidden': this.disabled || this.readonly }, variant: "subtle-tertiary", icon: index$1.iconCalendar, onClick: (event) => this.onCalenderClick(event), "aria-label": this.ariaLabelCalendarButton }))));
    }
...
exports.ix_date_input = DateInput;
//# sourceMappingURL=ix-date-input.entry.cjs.js.map
