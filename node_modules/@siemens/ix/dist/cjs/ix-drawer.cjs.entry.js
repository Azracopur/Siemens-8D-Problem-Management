...
const Drawer = class {
    ...
    async toggleDrawer(show) {
        ...
        if (show) {
            ...
            if (!this.toggle && this.divElement) {
                ...
                }, animation.Animation.mediumTime);
            }
        }
        else {
    ...
    render() {
        return (index.h(index.Host, { key: 'f40c42d1e7b7e8420c4a8f804a46b722580dd132', class: {
                ...
                overflow: 'hidden',
            }, ref: (el) => (this.divElement = el), "data-testid": "container", id: "div-container" }, index.h("div", { key: '810a3738ce5350281d758808ba93981914760877', style: {
                width: this.width === 'auto'
                    ? 'auto'
                    : `${this.getConstrainedWidth(this.width)}rem`,
            } }, index.h("div", { key: '5601266a5a02c122d1392234fe1c1a755e440bad', class: "header" }, index.h("div", { key: 'a43e56c621a03939233e10bb907e6f2bd7a7e176', class: "header-content" }, index.h("slot", { key: 'ab7c9e45ca78c512c1a242f53a616a16a98187fe', name: "header" })), index.h("ix-icon-button", { key: 'eaaa6f03ffdf2f5e2d9100ab3f45c4a1f46ef63d', class: "close-button", style: {
                display: this.showContent ? 'block' : 'none',
            }, icon: index$1.iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => this.onCloseClicked(), "data-testid": "close-button", "aria-label": this.ariaLabelCloseButton })), index.h("div", { key: '170d74d584fb7b641adaa45800144a27f4354d92', class: "content", style: {
                display: this.showContent ? 'block' : 'none',
            } }, index.h("slot", { key: 'de087859ac50be70b998ab696698df91f6816f21' })))));
    }
