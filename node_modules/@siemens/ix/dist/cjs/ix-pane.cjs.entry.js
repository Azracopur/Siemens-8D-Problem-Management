...
const Pane = class {
    ...
    onExpandedChange() {
        ...
        this.disposableWindowClick = disposableEventListener.addDisposableEventListener(window, 'click', (event) => {
            var _a;
    ...
    animateVerticalFadeIn(size) {
        let key = this.getKey();
        let animation$1 = anime_esm.animate(this.hostElement, {
    ...
    removePadding() {
        anime_esm.animate(this.hostElement.shadowRoot.querySelector('#title-div'), {
            duration: 0,
            paddingTop: 0,
            paddingBottom: 0,
            paddingLeft: 0,
    ...
    animateHorizontalPadding(size, duration = animation.Animation.mediumTime) {
        let key = this.getKey();
        let animation = anime_esm.animate(this.hostElement.shadowRoot.querySelector('#title-div'), {
            duration: duration,
            paddingTop: size,
            paddingBottom: size,
            easing: 'easeInOutSine',
