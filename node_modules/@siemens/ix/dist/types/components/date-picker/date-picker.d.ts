...
export declare class DatePicker implements IxDatePickerComponent {
    ...
    tempMonth: number;
    private readonly dropdownButtonRef;
    private readonly yearContainerRef;
    private readonly firstMonthRef;
    dayNames: string[];
    monthNames: string[];
    focusedDay: number;
    private isDayFocus;
    ...
    private updateSelectedYearMonth;
    onDayBlur(): void;
    onDayFocus(): void;
