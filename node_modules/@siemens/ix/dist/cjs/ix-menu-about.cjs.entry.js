...
var ixMenuSettings_entry = require('./ix-menu-settings-CtWl0bME.js');
...
const MenuAbout = class {
    ...
    updateTab(newLabel, oldLabel) {
        if (newLabel !== oldLabel) {
            ixMenuSettings_entry.syncTabDisplay(this, newLabel);
        }
    }
    componentWillLoad() {
        ixMenuSettings_entry.initialize(this);
    }
    componentDidLoad() {
        index.forceUpdate(this.el);
    }
    render() {
        return index.h(ixMenuSettings_entry.MenuTabs, { key: 'e49c1819db2fcba5b330c776c84e905d6f1aef87', context: this });
    }
...
//# sourceMappingURL=ix-menu-about.entry.cjs.js.map
