...
function checkFieldClasses(hostElement, includeChildren = false) {
    return {
        isInvalid: classListContains(hostElement, 'ix-invalid', includeChildren) ||
            classListContains(hostElement, 'ix-invalid--validity-invalid', includeChildren),
...
exports.HookValidationLifecycle = HookValidationLifecycle;
exports.checkFieldClasses = checkFieldClasses;
exports.createClassMutationObserver = createClassMutationObserver;
exports.getValidationText = getValidationText;
exports.shouldSuppressInternalValidation = shouldSuppressInternalValidation;
//# sourceMappingURL=validation-DTmSqO2d.js.map
