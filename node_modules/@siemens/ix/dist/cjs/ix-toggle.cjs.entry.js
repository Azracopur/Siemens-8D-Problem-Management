...
const Toggle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '990e3533b6e155d261dcdcf3dd7e06e0dceb8072', role: "switch", "aria-checked": a11y.a11yBoolean(this.checked), "aria-disabled": a11y.a11yBoolean(this.disabled), class: {
                disabled: this.disabled,
            }, onBlur: () => this.ixBlur.emit(), onFocus: () => (this.touched = true) }, index.h("label", { key: '568b91b6c2ad362dc753518f97ca98b2c45a4130', class: "wrapper" }, index.h("button", { key: 'dcbe522c2ccc95354cb982892eff554db86b4e8f', class: {
                switch: true,
                checked: this.checked,
                indeterminate: this.indeterminate,
            }, onClick: () => this.onCheckedChange(!this.checked), tabindex: -1, "aria-hidden": "true" }, index.h("div", { key: 'd281b839212a95e47b977bc46f052f7e6ca927c9', class: "slider" })), index.h("input", { key: '8169a27e13433034a97c97ca99507237332abb30', type: "checkbox", disabled: this.disabled, indeterminate: this.indeterminate, checked: this.checked, tabindex: 0, "aria-hidden": a11y.a11yBoolean(true), "aria-checked": a11y.a11yBoolean(this.checked), onChange: (event) => this.onCheckedChange(event.target.checked) }), !this.hideText && (index.h("ix-typography", { key: '7bc9b1f72447ff21057cdef3eb77a4ebd7a45ae7', class: "label" }, toggleText)))));
    }
...
//# sourceMappingURL=ix-toggle.entry.cjs.js.map
