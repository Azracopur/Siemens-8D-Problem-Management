...
const addDisposableChangesAndVisibilityObservers = (element, callback) => {
    ...
    const mutationObserver$1 = mutationObserver.createMutationObserver(callback);
    mutationObserver$1.observe(element, {
        subtree: true,
        attributes: true,
    });
    return () => {
...
exports.addDisposableChangesAndVisibilityObservers = addDisposableChangesAndVisibilityObservers;
