...
const FilterChip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '03b4a6c34e034efe267406a523a902e85665b351', class: { disabled: this.disabled, readonly: this.readonly }, title: this.hostElement.textContent }, index.h("div", { key: '75c8992cf2e8dc2d2ff76d1579219ff4bef46fd2', class: "slot-container" }, index.h("slot", { key: 'ea52727be5fa2cda2f9ddaa2a7a37a1c7c1f4f91' })), !this.disabled && !this.readonly ? (index.h("ix-icon-button", { variant: "tertiary", oval: true, icon: index$1.iconCloseSmall, size: "16", tabindex: this.disabled ? -1 : 0, disabled: this.disabled, onClick: (e) => this.onCloseClick(e), "aria-label": this.ariaLabelCloseIconButton })) : null));
    }
...
const SelectItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1602a154d8a1d9b4ee3d1755aea08df7a719cd37' }, index.h("ix-dropdown-item", { key: 'd02799ffee6add3546eafe812785b4ba9532ba6b', class: {
