...
const Button = class {
    ...
    setFocus() {
        var _a;
        (_a = this.hostElement
            .shadowRoot.querySelector(this.href ? 'a' : 'button')) === null || _a === void 0 ? void 0 : _a.focus();
    }
    render() {
        ...
        return (index.h(index.Host, { key: 'd59ad1ad7693982ea33b27383a41edfca9a59430', class: {
                disabled: this.disabled || this.loading,
            } }, index.h(baseButton.BaseButton, Object.assign({ key: 'd27e0296718f433c7df2896bd73b5991ef302c9a' }, baseButtonProps), index.h("slot", { key: 'c246c59dfd3406d389b9059020422f7a9779ab67' }))));
    }
