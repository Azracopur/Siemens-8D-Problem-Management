...
const EmptyState = class {
    ...
    render() {
        return (index.h(index.Host, { key: '40044bc561b77f0ca121fec086c4e50959cd84b8', class: `emptyState emptyState--${this.layout}` }, this.icon && (index.h("div", { key: '4f7caad68b5bfdae9a3becc0d9cb86e6aa121b9a', class: "emptyState__icon" }, index.h("ix-icon", { key: '4f3540bc8589358f3a81136bf18e37a963ccf8c4', name: this.icon, size: this.layout === 'large' ? '32' : '32', color: "color-soft-text", "aria-label": this.ariaLabelEmptyStateIcon }))), index.h("div", { key: 'aa658e73609ff249ada8b4a11897bc6fd16f3e27', class: "emptyState__content" }, index.h("div", { key: 'f46a03dcf711bdfc3919d3f94e5b60e64f434173', class: "content__label" }, index.h("ix-typography", { key: 'dd56a7bc024921adedf792ed956614a13a7dd723', format: this.layout === 'large' ? 'h3' : 'body' }, this.header), this.subHeader && (index.h("div", { key: '7813b0fd9e490328b24566ae0abb805dbc2d1b3b', class: "label__subHeader" }, this.subHeader))), this.action && (index.h("div", { key: '4ffbf8f873bff95e04376dac344cd312d39a68d6', class: "content__action" }, index.h("ix-button", { key: '20739fd736c3176034dcc6d564c09879f745b9b3', onClick: () => this.actionClick.emit() }, this.action))))));
    }
};
