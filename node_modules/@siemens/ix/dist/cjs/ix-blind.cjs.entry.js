...
const Blind = class {
    ...
    rotateChevronUp() {
        anime_esm.animate(this.chevronRef, {
            duration: animation.Animation.defaultTime,
            easing: 'easeInOutSine',
            rotateZ: 180,
        });
        anime_esm.animate(this.content, {
            duration: animation.Animation.defaultTime,
            easing: 'easeInOutSine',
            opacity: 1,
        });
    ...
    render() {
        return (index.h(index.Host, { key: '671ad2c0686ea67b8dd5a3b6259edd8cd2667b19', class: {
                [`blind-${this.variant}`]: true,
            } }, index.h("div", { key: '40fa7a9d37b674e2979022aadc84a4496ea9a9f5', class: 'blind-header-wrapper' }, index.h("button", { key: '29c3e84c41ec924f2b3c5a373778130afa943626', class: {
                'blind-header': true,
                [`blind-${this.variant}`]: true,
                closed: this.collapsed,
            }, type: "button", "aria-labelledby": `ix-blind-header-title-${this.blindId}`, "aria-controls": `ix-blind-content-section-${this.blindId}`, "aria-expanded": a11y.a11yBoolean(!this.collapsed), onClick: () => this.onHeaderClick() }, index.h("slot", { key: 'b252b735380d02d028f14e7d9fbe4c5eba8c6602', name: "custom-header" })), index.h("div", { key: '6bf0d3c1465c63a94c8f022734ed826c4028855a', class: 'blind-header-content' }, index.h("ix-icon", { key: 'd21dd7db4cb813e4becce868c4dbe340a12b1e65', class: "collapse-icon", name: index$1.iconChevronDownSmall, color: this.variant === 'filled' || this.variant === 'outline'
                ? 'color-std-text'
                : `color-${this.variant}--contrast`, ref: (ref) => (this.chevronRef = ref) }), index.h("div", { key: 'da2e1435ca1070eed1794226ca721e7e3fb22390', class: "blind-header-title", id: `ix-blind-header-title-${this.blindId}` }, this.label !== undefined ? (index.h(index.Fragment, null, this.icon && (index.h("ix-icon", { class: "blind-header-title-icon", name: this.icon, color: this.variant === 'filled' || this.variant === 'outline'
                ? 'color-std-text'
                : `color-${this.variant}--contrast` })), index.h("div", { class: 'blind-header-title-row' }, index.h("div", { class: "blind-header-title-col" }, index.h("ix-typography", { title: this.label, format: "label-lg", bold: true }, index.h("div", { class: "blind-header-title-label", title: this.label }, this.label))), this.sublabel && (index.h("div", { class: "blind-header-title-col" }, index.h("ix-typography", { title: this.sublabel }, index.h("div", { class: "blind-header-title-sublabel" }, this.sublabel))))), index.h("div", { class: "header-actions" }, index.h("slot", { name: "header-actions" })))) : null))), index.h("section", { key: '854dd19e82a63ccb31f090dadfbcfa46d7346d21', id: `ix-blind-content-section-${this.blindId}`, "aria-labelledby": `ix-blind-header-title-${this.blindId}` }, index.h("div", { key: '12f77fdbb29c89d5ab26877e9db8ad9ec79f1e6f', class: {
                'blind-content': true,
                hide: this.collapsed,
...
//# sourceMappingURL=ix-blind.entry.cjs.js.map
