...
export class Chip {
    ...
    render() {
        ...
        return (h(Host, { key: '89e8d6fc156f9b2b761000d213655b36f3b16bf2', tabIndex: "-1", class: {
                inactive: this.inactive,
            }, style: this.variant === 'custom'
                ? {
                    '--ix-icon-button-color': this.chipColor,
                }
                : {} }, h("div", { key: 'a9b92e446d5c668d449996a93627879b428478e5', ref: this.containerElementRef, style: Object.assign({}, customStyle), class: {
                container: true,
            ...
            } }, h("div", { key: 'f3bf2fa31dfbaec0d014dbfa972ad822e2514e91', class: "content-wrapper" }, this.icon && (h("ix-icon", { key: '066a4f272fa760fafd6c69cd6b0f05bf459a3604', class: {
                'with-icon': true,
            }, name: this.icon, size: '24', style: this.variant === 'custom'
                ? { color: this.outline ? this.background : this.chipColor }
                : undefined })), h("span", { key: 'e08beb2e151300bdcdfe62c0b6a832935a7d2f68', class: "slot-container" }, h("slot", { key: 'b087848f9f85fc01af5cc3a03d4ae885e0f01335' }))), this.inactive === false && this.closable && this.getCloseButton()), this.getTooltip()));
    }
        ...
        return {
            ...
            "tooltipText": {
                ...
                "docs": {
                    ...
                    "text": "Display a tooltip. By default, no tooltip will be displayed.\nAdd the attribute to display the text content of the component as a tooltip or use a string to display a custom text."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "centerContent": {
                ...
                "docs": {
                    ...
                    "text": "Center the content of the chip.\nSet to false to disable centering."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
