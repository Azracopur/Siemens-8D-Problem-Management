...
export const getButtonClasses = (variant, iconOnly = false, iconOval = false, selected, disabled) => {
    return {
        btn: true,
        [`btn-${variant}`]: true,
        'btn-icon': iconOnly,
...
export const BaseButton = (props, children) => {
    ...
    const buttonContent = [
        ...
        props.iconRight ? (h("ix-icon", { class: "icon-right", name: props.iconRight, size: props.iconSize, color: props.iconColor })) : null,
        props.afterContent ? props.afterContent : null,
    ];
    // If href is provided, render as an anchor tag
    if (props.href) {
        return (h("a", Object.assign({}, commonAttributes, { href: props.disabled ? undefined : props.href, target: props.target, role: "button", rel: props.rel, onClick: (e) => handleOnClick(e, props) }), buttonContent));
    }
