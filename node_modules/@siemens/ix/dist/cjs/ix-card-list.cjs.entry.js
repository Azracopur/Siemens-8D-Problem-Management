...
function CardListTitle(props) {
    ...
    return (index.h("div", { class: "CardList_Title" }, index.h("ix-icon-button", { variant: "tertiary", icon: index$1.iconChevronDown, onClick: props.onClick, iconColor: "color-primary", class: {
            CardList__Title__Button: true,
            CardList__Title__Button__Collapsed: props.isCollapsed,
        }, "aria-label": props.ariaLabelExpandButton }), index.h("ix-typography", { class: "CardList_Title__Label", format: "body-lg" }, props.label), !props.hideShowAll && (index.h("ix-button", { class: "CardList__Title__Show__All", variant: "tertiary", onClick: props.onShowAllClick }, index.h("span", null, props.showAllLabel), index.h("span", null, !isNaN(props.showAllCounter) ? ` (${props.showAllCounter})` : null)))));
}
const CardList = class {
    ...
    render() {
        return (index.h(index.Host, { key: '37a1bb98b5703b76b6f0f5038561917bef13916b' }, index.h(CardListTitle, { key: '8f90c6052259ff8e1bbb377a9fa9cc465c951aab', isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === undefined
                ? this.numberOfAllChildElements
                : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), index.h("div", { key: '1d1162c53d8fb1d97dfb4b00ae1c1a5942a0b0f7', class: {
                CardList__Overflow: true,
            }, style: this.computeMaskLayer() }, index.h("div", { key: '298741cb6e8f1617e9a3ca1f0b49d713c3421977', class: {
            ...
            }, onScroll: () => this.onCardListScroll() }, index.h("slot", { key: 'abccd55d11dae4c83b6d7dcdabc77aec0a2f7b32', onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? (index.h("ix-card", { class: {
