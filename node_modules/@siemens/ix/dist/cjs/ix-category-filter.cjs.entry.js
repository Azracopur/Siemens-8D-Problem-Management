...
const CategoryFilter = class {
    ...
    renderPlainSuggestions() {
        return (index.h("div", { class: "dropdown-item-container" }, this.getFilteredSuggestions().map((suggestion) => (index.h("button", { class: "dropdown-item", "data-id": suggestion, onClick: () => {
                var _a, _b;
    ...
    getResetButton() {
        return (index.h("ix-icon-button", { onClick: (e) => this.resetFilter(e), class: {
            ...
            }, variant: "tertiary", oval: true, icon: index$1.iconClear, iconColor: "color-soft-text", size: "16", "aria-label": this.ariaLabelResetButton }));
    }
    getIconColor() {
        if (this.disabled) {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '6040e5611b073b5df60b2f021a1fd6521a6de1df' }, index.h("form", { key: '4baf23174e46355ca7fbd5ecad14145cabaea8d5', ref: (el) => (this.formElement = el) }, index.h("div", { key: 'adecb78f948b498e0a9f42355ab590e2966958d1', "read-only": this.readonly, class: {
                'input-container': true,
                disabled: this.disabled,
                focus: this.hasFocus,
                readonly: this.readonly,
                'no-icon': this.hideIcon,
            } }, index.h("ix-icon", { key: '4430f91076d6d7d04e1b9beea3a62877835b527f', color: this.getIconColor(), class: { 'display-none': this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : index$1.iconSearch, size: "16" }), index.h("div", { key: 'aeaef4cf293c3b6c8baca478ec788ce33ecabfb6', class: "token-container" }, index.h("div", { key: 'd599d0c8173bef92c64ad71cff0e89dabc7fde99', class: "list-unstyled" }, this.filterTokens.map((value, index$1) => (index.h("span", { key: value.toString(), class: {
            ...
            } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label)), index.h("input", Object.assign({ key: '43eac9a872f30a34780aa702c6905348649018b5', class: {
                'text-input': true,
