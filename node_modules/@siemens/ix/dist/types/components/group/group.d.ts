...
export declare class Group {
    ...
    showExpandCollapsedIcon: boolean;
    hasDropdown: boolean;
    private observer;
    selectedChanged(newSelected: boolean): void;
    get dropdownItems(): Element[];
    get groupItems(): Array<HTMLIxGroupItemElement>;
    get groupContent(): Element | null | undefined;
    private onExpandClick;
    private onHeaderClick;
    private changeHeaderSelection;
    private changeItemIndex;
    private onSlotChange;
    private checkDropdownSlot;
    componentWillRender(): void;
    componentDidLoad(): void;
    disconnectedCallback(): void;
    onItemClicked(event: CustomEvent): void;
    render(): any;
}
