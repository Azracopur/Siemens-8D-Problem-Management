...
const Modal = class {
    ...
    slideInModal() {
        const duration = this.disableAnimation ? 0 : animation.Animation.mediumTime;
        const translateY = this.centered ? ['-90%', '-50%'] : [0, 40];
        anime_esm.animate(this.dialog, {
            duration,
            opacity: [0, 1],
            translateY,
            translateX: ['-50%', '-50%'],
    ...
    render() {
        return (index.h(index.Host, { key: '0170729f63356223c39bcd6b0bb7124b2036f2c4', class: {
                visible: this.modalVisible,
                'no-backdrop': this.hideBackdrop,
                'align-center': this.centered,
            } }, index.h("div", { key: '436b9f2efce7279defa936c9ee79fa44d090e388', class: "dialog-backdrop" }, index.h("dialog", { key: 'e3bc4891433993a5dcbe186011fd91d70277ca3d', "aria-modal": a11y.a11yBoolean(true), "aria-describedby": this.ariaAttributes['aria-describedby'], "aria-labelledby": this.ariaAttributes['aria-labelledby'], class: {
                modal: true,
                [`modal-size-${this.size}`]: true,
            }, onClose: () => this.dismissModal(), onMouseDown: (event) => this.onMouseDown(event), onMouseUp: (event) => this.onMouseUp(event), onCancel: (e) => {
                e.preventDefault();
                this.dismissModal();
            } }, index.h("slot", { key: '5a3e86b9c04f8e1564be6026b0352940978f0666' })))));
    }
    get hostElement() { return index.getElement(this); }
};
__decorate([
    listener.OnListener('keydown', (self) => self.disableEscapeClose)
