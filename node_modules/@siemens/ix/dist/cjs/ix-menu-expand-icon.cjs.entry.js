...
const MenuExpandIcon = class {
    ...
    getSmallScreenIcon() {
        return (index.h("button", { class: Object.assign(Object.assign({}, baseButton.getButtonClasses('subtle-tertiary', true, false, false, false)), { 'menu-expand-button': true }) }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "24", height: "24" }, index.h("rect", { class: "line line-1", x: "2", y: "5", width: "20", height: "2" }), index.h("rect", { class: "line line-2", x: "2", y: "11", width: "13", height: "2" }), index.h("rect", { class: "line line-3", x: "2", y: "17", width: "20", height: "2" }))));
    }
    getLargeScreenIcon() {
        return (index.h("ix-icon-button", { icon: this.expanded ? index$1.iconDoubleChevronLeft : index$1.iconDoubleChevronRight, variant: "subtle-tertiary" }));
    }
    getMenuIcon() {
        if (this.pinned) {
    ...
    render() {
        return (index.h(index.Host, { key: '702baa75b182df885e9488301b2747fb37f96c52', class: {
