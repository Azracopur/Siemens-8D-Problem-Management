...
const ExpandingSearch = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'a7502cbddcb136608813c4fe522e868ae3d5806d', class: {
                expanded: this.expanded,
                'right-position': this.expanded,
                fullWidth: this.fullWidth,
            } }, index.h("ix-icon-button", { key: 'ad6ed825caea25be04469731e4eb8c33d08b1ad0', size: this.expanded ? '16' : '24', icon: (_a = this.icon) !== null && _a !== void 0 ? _a : index$1.iconSearch, variant: this.expanded ? 'tertiary' : this.variant, "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? 'input-search-icon--color--focus' : undefined, class: {
                'btn-search': true,
                'btn-search--expanded': this.expanded,
            }, "aria-label": this.ariaLabelSearchIconButton }), index.h("div", { key: 'b12d4ab2b26f00564d6edc1c3fd0d0f1ba48a8c2', class: {
                expanded: this.expanded,
                fullWidth: this.fullWidth,
                collapsed: !this.expanded,
                'disable-pointer': !this.expanded,
                'input-container': true,
            }, "data-testid": "input-wrapper" }, index.h("input", { key: '47f11db65a0f58d1fb0c77239062b8414538d200', class: {
                ...
                this.collapseInput();
                this.hasFocus = false;
            }, onFocus: () => (this.hasFocus = true), onInput: (e) => this.onChange(e), tabindex: this.expanded ? 0 : -1, "aria-label": this.ariaLabelSearchInput }), this.isFieldChanged ? (index.h("ix-icon-button", { class: "btn-clear", icon: index$1.iconClear, variant: "subtle-tertiary", size: "16", "data-testid": "clear-button", onClick: () => this.clearClicked(), "aria-label": this.ariaLabelClearIconButton })) : null)));
    }
};
