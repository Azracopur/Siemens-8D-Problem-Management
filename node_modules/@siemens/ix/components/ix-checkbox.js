import { p as proxyCustomElement, H, e as createEvent, h, F as Fragment, d as Host } from './p-D-__gyet.js';
...
const Checkbox = /*@__PURE__*/ proxyCustomElement(class Checkbox extends H {
    ...
    render() {
        return (h(Host, { key: 'f2157c572321b0a34f54f32423ed0c821fc1abfa', "aria-checked": a11yBoolean(this.checked), "aria-disabled": a11yBoolean(this.disabled), role: "checkbox", class: {
                disabled: this.disabled,
                checked: this.checked,
                indeterminate: this.indeterminate,
            }, onFocus: () => (this.touched = true), onBlur: () => this.ixBlur.emit() }, h("label", { key: '131587a06d955e04dc580936004546e930ec9cf8' }, h("input", { key: 'b8a94c99f540e21c280ba9aeaf35221fa1c9b226', "aria-checked": a11yBoolean(this.checked), required: this.required, disabled: this.disabled, checked: this.checked, ref: this.inputRef, type: "checkbox", onChange: () => this.setCheckedState(!this.checked) }), h("button", { key: '6f6c5937801659bacd7d6f5c9256972c33e4194c', disabled: this.disabled, class: {
                checked: this.checked,
            }, onClick: () => this.setCheckedState(!this.checked) }, this.renderCheckmark()), h("ix-typography", { key: '7b33f317ac3757242509d69a25520795906bb158', format: "label", textColor: this.disabled ? 'weak' : 'std' }, this.label, h("slot", { key: '2ab4518ebcb6135de6b1c37a7e9c157b1feebb5d' })))));
    }
