...
import { l as iconCalendar } from './p-BvsadYCu.js';
import { D as DateTime } from './p-bDicGJUN.js';
import { a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, h as handleSubmitOnEnterKeydown, S as SlotEnd, c as SlotStart } from './p-DUU5I7wZ.js';
import { H as HookValidationLifecycle, c as createClassMutationObserver, g as getValidationText } from './p-Dq_H2flK.js';
...
import { d as defineCustomElement$a } from './p-CjDPpSJX.js';
import { d as defineCustomElement$9 } from './p-COWPG_SD.js';
import { d as defineCustomElement$8 } from './p-BI7B-PUA.js';
...
const DateInput = /*@__PURE__*/ proxyCustomElement(class DateInput extends H {
    ...
    renderInput() {
        ...
        return (h("div", { class: "input-wrapper" }, h(SlotStart, { slotStartRef: this.slotStartRef, onSlotChange: () => this.updatePaddings() }), h("input", { autoComplete: "off", class: {
            ...
            } }), h(SlotEnd, { slotEndRef: this.slotEndRef, onSlotChange: () => this.updatePaddings() }, h("ix-icon-button", { "data-testid": "open-calendar", class: { 'calendar-hidden': this.disabled || this.readonly }, variant: "subtle-tertiary", icon: iconCalendar, onClick: (event) => this.onCalenderClick(event), "aria-label": this.ariaLabelCalendarButton }))));
    }
