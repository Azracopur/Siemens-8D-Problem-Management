...
const DropdownHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8c2634f5c46a222e4803fa7ae426fcdf9d8edaf4' }, index.h("ix-typography", { key: '0951a5b06d746db809529a9149e021696507ade2', class: 'category-text', format: 'h5' }, this.label)));
    }
};
