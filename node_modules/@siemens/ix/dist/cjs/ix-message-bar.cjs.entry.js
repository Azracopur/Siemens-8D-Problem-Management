...
const MessageBar = class {
    constructor(hostRef) {
        ...
        this.closeAnimationCompleted = index.createEvent(this, "closeAnimationCompleted", 7);
        /**
    ...
    render() {
        return (index.h(index.Host, { key: '538fcc08ad07fe808f424e067a361f4a56f4c0ec' }, index.h("div", { key: '4a75052efe1b22c247dcfcd298aabbd1098ff7b6', class: { 'message-container': true, [this.type]: true }, role: "alert", ref: (el) => (this.divElement = el) }, index.h("ix-icon", { key: 'd348829692e38a1023e044834aefa45516b4d916', color: this.color, name: this.icon }), index.h("div", { key: '0ac0a509efe1dd246f7732660e4cf16416c8655d', class: "message-content" }, index.h("slot", { key: '6143bfa9cf39d32d149c2893b7712358337833c9' })), !this.persistent && (index.h("ix-icon-button", { key: 'b118c91956af0fd00d02cfefdb7da36d46f2d360', icon: index$1.iconClose, iconColor: "color-soft-text", size: "24", variant: "tertiary", onClick: () => {
                if (this.divElement) {
...
MessageBar.messageTypeConfigs = {
    ...
    alarm: { icon: index$1.iconError, color: 'color-alarm' },
    critical: { icon: index$1.iconWarningRhomb, color: 'color-critical' },
    warning: { icon: index$1.iconWarning, color: 'color-warning-text' },
    success: { icon: index$1.iconSuccess, color: 'color-success' },
    info: { icon: index$1.iconInfo, color: 'color-info' },
    neutral: { icon: index$1.iconNotification, color: 'color-neutral' },
    primary: { icon: index$1.iconNotification, color: 'color-primary' },
};
MessageBar.style = messageBarCss;

exports.ix_message_bar = MessageBar;
//# sourceMappingURL=ix-message-bar.entry.cjs.js.map
