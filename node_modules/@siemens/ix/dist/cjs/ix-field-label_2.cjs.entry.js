...
const FormFieldLabel = class {
    ...
    async registerControlRefObserver() {
        ...
        if (this.controlRef) {
            ...
            this.controlRefClassObserver = validation.createClassMutationObserver(input, () => this.checkForInvalidState(input));
        }
    }
    registerHtmlForClassObserver(forElement) {
        ...
        this.htmlForClassObserver = validation.createClassMutationObserver(forElement, () => this.checkForInvalidState(forElement));
    }
    ...
    render() {
        return (index.h(index.Host, { key: 'ca4f1ba84a3a19a4d15aa517272c90bebf782e13', onClick: () => this.focusOnClick() }, index.h("label", Object.assign({ key: '44e2386d5dd7c51d3b5a9e1530e986b15ba64d23', htmlFor: this.htmlFor }, this.a11yAttributes, { ref: this.labelRef }), index.h("ix-typography", { key: 'ab97048f7a521ad398438795ba7a5ccba2571f4c', textColor: this.isInvalid ? 'alarm' : 'soft', format: "label" }, index.h("slot", { key: 'faf628440f832acb412c7f5b40dab4620da785d7' }), this.required && index.h("span", { key: 'd15676e3bf2d645ce2e1fc8f3bd91af23b6ec725' }, "*")))));
    }
...
const FieldWrapper = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a27a9cefcce30e8dc30ca6a3fd72164227e86fdf' }, this.label && (index.h("div", { key: 'ef4a8585d24c3b0400e85b1a21bd9344e01bcb47', class: "field-top" }, index.h("ix-field-label", { key: '93c9f7cfbbde681956a7676721f1dd0821907e89', required: this.required, htmlFor: this.htmlForLabel, controlRef: this.controlRef, isInvalid: this.isInvalid }, this.label))), index.h("div", { key: '3a26cb08a91fc7c0f10de83a5b722b5af66f059f', class: {
                'slot-wrapper': true,
            }, ref: this.slotRef }, index.h("slot", { key: 'fe73a444a23928cee7f7899cc3bb6aef76eefa68' })), index.h("div", { key: 'bc5fa34c5a05e49427e63a87d70db0735a0a0b80', class: 'field-bottom' }, !this.showTextAsTooltip && index.h(helperTextUtil.HelperText, Object.assign({ key: '67abdfcf2448d8df422cd0ee39c162f423e5c564' }, textOptions)), index.h("div", { key: 'fecb02a2e534980491ea776cdc952b1aeea41286', class: "bottom-right" }, index.h("slot", { key: '9a958f810edf477be93394d887724c9763c57f17', name: "bottom-right" }))), this.showTextAsTooltip === true && helperTextUtil.hasAnyText(textOptions) && (index.h("ix-tooltip", { key: 'd3d8810548d267811e5f298fbb41f657abbae27d', for: this.slotRef.waitForCurrent(), showDelay: 500, placement: "bottom" }, index.h(helperTextUtil.HelperText, Object.assign({ key: '44c241959d5db7e91c00a08a843a51dfc9307256' }, textOptions))))));
    }
    get hostElement() { return index.getElement(this); }
};
FieldWrapper.style = fieldWrapperCss;

exports.ix_field_label = FormFieldLabel;
exports.ix_field_wrapper = FieldWrapper;
//# sourceMappingURL=ix-field-label.ix-field-wrapper.entry.cjs.js.map
