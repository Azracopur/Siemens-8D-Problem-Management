...
import type { BorderlessChangedEvent, Composition, ExpandedChangedEvent, HideOnCollapseChangedEvent, SlotChangedEvent, VariantChangedEvent } from './pane.types';
/**
...
export declare class Pane {
    ...
    private static readonly collapsedPane;
    private static readonly collapsedPaneMobile;
    private readonly animations;
    private animationCounter;
    private mutationObserver?;
    private resizeObserver?;
    private disposableWindowClick?;
