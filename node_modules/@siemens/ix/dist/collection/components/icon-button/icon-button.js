        ...
        return {
            "a11yLabel": {
                ...
                "docs": {
                    "tags": [{
                            "name": "deprecated",
                            "text": "Set the native `aria-label` on the ix-icon-button host element. Will be removed in 5.0.0"
                        }],
            ...
            "variant": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "IconButtonVariant": {
                            "location": "import",
                            "path": "./icon-button.types",
                            "id": "src/components/icon-button/icon-button.types.ts::IconButtonVariant"
                        }
                    }
                },
                "required": false,
