...
const ToggleButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dab3970ea3719c9652d0802710947590c262faaa', class: {
                disabled: this.disabled || this.loading,
            } }, index.h(baseButton.BaseButton, Object.assign({ key: '51e50d08005f42839aa65e7e2e86269158633fc6' }, baseButtonProps), index.h("slot", { key: '0e8e22fc517fd98f815b89c5f519e3556589f833' }))));
    }
};
