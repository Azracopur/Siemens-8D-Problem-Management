...
import { i as iconMoreMenu, e as iconChevronDown } from './p-BvsadYCu.js';
import { d as defineCustomElement$7 } from './p-C6_1qmP4.js';
import { d as defineCustomElement$6 } from './p-hwPzPVf8.js';
import { d as defineCustomElement$5 } from './p-B45tl2du.js';
...
function CardListTitle(props) {
    ...
    return (h("div", { class: "CardList_Title" }, h("ix-icon-button", { variant: "tertiary", icon: iconChevronDown, onClick: props.onClick, iconColor: "color-primary", class: {
        ...
        }, "aria-label": props.ariaLabelExpandButton }), h("ix-typography", { class: "CardList_Title__Label", format: "body-lg" }, props.label), !props.hideShowAll && (h("ix-button", { class: "CardList__Title__Show__All", variant: "tertiary", onClick: props.onShowAllClick }, h("span", null, props.showAllLabel), h("span", null, !isNaN(props.showAllCounter) ? ` (${props.showAllCounter})` : null)))));
}
