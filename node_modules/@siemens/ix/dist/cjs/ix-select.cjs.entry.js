...
const Select = class {
    ...
    renderAllChip() {
        return (index.h("ix-filter-chip", { disabled: this.disabled || this.readonly, ariaLabelCloseIconButton: this.i18nAllSelected, onCloseClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.clear();
    ...
    renderChip(item) {
        return (index.h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.itemClick(item.value);
            } }, item.label));
    ...
    render() {
        var _a, _b, _c, _d;
        return (index.h(index.Host, { key: '1610cc7dd06025b8dc05cd905eb1fad5574a64f8', "aria-disabled": a11y.a11yBoolean(this.disabled), class: {
                disabled: this.disabled,
            } }, index.h("ix-field-wrapper", { key: '912ca0f6e59259ea7de5fbb4857357fcf1db8370', required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, index.h("div", { key: '217ad54b9ca7a3e7aa9e60d89482b5fbc5389fc1', class: {
                select: true,
                disabled: this.disabled,
            ...
            } }, index.h("div", { key: '58d7051c6e884dc714643dcf974f7424b4581dfb', class: "input-container" }, index.h("div", { key: 'be6fec6f27345d8033b9b56ca3760c953951b801', class: "chips" }, this.isMultipleMode &&
            this.items.length !== 0 &&
            (this.shouldDisplayAllChip()
                ? this.renderAllChip()
                : (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => this.renderChip(item))), index.h("div", { key: 'a9b0c66c623856ab4b2c34f136bbef89a4b3377f', class: "trigger" }, index.h("input", { key: '1920a23f38ce924fae991be2b5c4a760031aae1f', autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
            ...
            !this.disabled &&
            !this.readonly &&
            (((_d = this.selectedLabels) === null || _d === void 0 ? void 0 : _d.length) || this.inputFilterText) ? (index.h("ix-icon-button", { key: "clear", class: "clear", icon: index$1.iconClear, variant: "subtle-tertiary", oval: true, size: "16", onClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.clear();
            }, "aria-label": this.ariaLabelClearIconButton })) : null, this.disabled || this.readonly ? null : (index.h("ix-icon-button", { "data-select-dropdown": true, key: "dropdown", class: { 'dropdown-visible': this.dropdownShow }, icon: this.dropdownShow
                ? index$1.iconChevronUpSmall
                : index$1.iconChevronDownSmall, variant: "subtle-tertiary", ref: (ref) => {
                if (this.editable)
                    this.dropdownWrapperRef(ref);
            }, "aria-label": this.ariaLabelChevronDownIconButton }))))))), index.h("ix-dropdown", { key: '4fcf2193ed3cc0faea0e5de7acab2835751c5583', ref: (ref) => (this.dropdownElement = ref), show: this.dropdownShow, closeBehavior: this.isMultipleMode ? 'outside' : 'both', class: {
            ...
            } }, index.h("div", { key: '428a499947d6f345a83d075d1749831d6b1ab348', class: {
                'select-list-header': true,
                hidden: this.hideListHeader || this.isDropdownEmpty,
            }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), index.h("slot", { key: '9bffa4284f53b45116dfff2f142fd2f4aea2032c', onSlotchange: () => {
                this.updateSelection();
            } }), index.h("div", { key: 'a039c9fda5d61358d39ae9cdc08df2fc82b55fa7', ref: (ref) => (this.customItemsContainerElement = ref) }), this.isAddItemVisible() ? (index.h("ix-dropdown-item", { "data-testid": "add-item", icon: index$1.iconPlus, class: {
                'add-item': true,
...
//# sourceMappingURL=ix-select.entry.cjs.js.map
