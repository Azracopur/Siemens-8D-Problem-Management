...
const Avatar = class {
    ...
    render() {
        ...
        const Avatar = (index.h(index.Fragment, null, index.h(AvatarImage, { image: this.image, initials: this.initials, a11yLabel: a11yLabel !== null && a11yLabel !== void 0 ? a11yLabel : this.a11yLabel }), !!tooltipText && (index.h("ix-tooltip", { ref: this.tooltipRef, for: this.hostElement, "aria-hidden": a11y.a11yBoolean(ariaHidden), "aria-label": this.ariaLabelTooltip }, tooltipText))));
        if (this.isClosestApplicationHeader) {
            return (index.h(index.Host, { slot: "ix-application-header-avatar", class: 'avatar-button' }, index.h(baseButton.BaseButton, { disabled: false, iconOval: false, icon: undefined, iconOnly: false, loading: false, selected: false, type: "button", variant: "tertiary" }, Avatar), index.h("ix-dropdown", { ref: (ref) => (this.dropdownElement = ref), trigger: this.resolveAvatarTrigger(), class: "avatar-dropdown", onClick: (e) => this.onDropdownClick(e), onShowChanged: (event) => {
                    if (event.detail && this.tooltipRef.current) {
                        this.tooltipRef.current.hideTooltip(0);
                    }
                } }, this.username && (index.h(index.Fragment, null, index.h(UserInfo, { extra: this.extra, image: this.image, initials: this.initials, userName: this.username, a11yLabel: a11yLabel !== null && a11yLabel !== void 0 ? a11yLabel : this.a11yLabel }), this.hasSlottedElements && (index.h("ix-divider", { onClick: (e) => e.preventDefault() })))), index.h("slot", { onSlotchange: () => this.slottedChanged(), ref: (ref) => (this.slotElement = ref) }))));
        }
        return index.h(index.Host, null, Avatar);
    }
