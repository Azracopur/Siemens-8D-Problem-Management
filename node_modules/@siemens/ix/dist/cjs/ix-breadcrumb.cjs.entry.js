...
const Breadcrumb = class {
    constructor(hostRef) {
        ...
        this.previousButtonRef = makeRef.makeRef();
        this.nextButtonRef = makeRef.makeRef();
        this.items = [];
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c5457acd786da77d474f83613a2c12910a193779' }, index.h("ix-dropdown", { key: '3f1e0ae1e4ac1d192ff7c0d5619329cfbcdf8a62', id: this.previousDropdownId, "aria-label": this.ariaLabelPreviousButton, trigger: ((_a = this.items) === null || _a === void 0 ? void 0 : _a.length) > this.visibleItemCount
                ...
                if (previousButton) {
                    index.forceUpdate(previousButton);
                }
            } }, this.items
        ...
        })), ((_b = this.items) === null || _b === void 0 ? void 0 : _b.length) > this.visibleItemCount ? (index.h("ix-breadcrumb-item", { id: this.previousButtonId, ref: this.previousButtonRef, label: "...", tabIndex: 1, onItemClick: (event) => event.stopPropagation(), "aria-describedby": this.previousDropdownId, "aria-controls": this.previousDropdownId, "aria-expanded": a11y.a11yBoolean(this.isPreviousDropdownExpanded), class: 'previous-button' })) : null, index.h("nav", { key: '11b4a0c0cbad59437fccee34a73cd4e89de39a1c', class: "crumb-items", "aria-label": (_c = a11y$1['aria-label']) !== null && _c !== void 0 ? _c : 'breadcrumbs' }, index.h("ol", { key: 'ad9d8c27e05b76f334f7cf6f79038d339e8d538c' }, index.h("slot", { key: 'd84c2c0028e22cbfd126b867177ba9b4271e8c24' }))), index.h("ix-dropdown", { key: '6ba681eb8f116ec287961a7e873b90d381baefdb', trigger: this.nextButtonRef.waitForCurrent() }, (_d = this.nextItems) === null || _d === void 0 ? void 0 : _d.map((item) => (index.h("ix-dropdown-item", { label: item, onClick: (e) => {
                this.nextClick.emit({
                    event: e,
                    item,
                });
...
//# sourceMappingURL=ix-breadcrumb.entry.cjs.js.map
