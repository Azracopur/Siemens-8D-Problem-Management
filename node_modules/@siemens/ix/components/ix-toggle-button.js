...
const ToggleButton = /*@__PURE__*/ proxyCustomElement(class ToggleButton extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'dab3970ea3719c9652d0802710947590c262faaa', class: {
                disabled: this.disabled || this.loading,
            } }, h(BaseButton, Object.assign({ key: '51e50d08005f42839aa65e7e2e86269158633fc6' }, baseButtonProps), h("slot", { key: '0e8e22fc517fd98f815b89c5f519e3556589f833' }))));
    }
    static get style() { return toggleButtonCss; }
}, [257, "ix-toggle-button", {
        "variant": [1],
        "disabled": [516],
        "loading": [4],
        "icon": [1],
