...
export declare const closestIxMenu: (element: Element) => HTMLIxMenuElement | null;
export type AppSwitchConfigurationTarget = LiteralStringUnion<'_self' | '_blank' | '_parent' | '_top'>;
