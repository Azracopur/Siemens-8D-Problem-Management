...
const MenuSettings = class {
    ...
    render() {
        return index.h(MenuTabs, { key: 'bff35655d1e57ea807a1d8a6bd0879f8804e3ef4', context: this });
    }
...
const MenuTabs = ({ context }) => {
    ...
    return (index.h(index.Host, { slot: context instanceof MenuSettings ? 'ix-menu-settings' : 'ix-menu-about', class: {
            show: context.show,
        } }, index.h("div", { class: context instanceof MenuSettings ? 'settings-header' : 'about-header' }, index.h("h2", { class: "text-h2" }, context.label), index.h("ix-icon-button", { variant: "tertiary", size: "24", icon: index$1.iconClose, iconColor: "color-soft-text", onClick: (e) => context.close.emit({
            name: context instanceof MenuSettings
                ? 'ix-menu-settings'
                : 'ix-menu-about',
            nativeEvent: e,
        }) })), index.h("ix-tabs", { selected: selectedIndex !== -1 ? selectedIndex : 0 }, getTabItems(context)), index.h("slot", null)));
};

exports.MenuSettings = MenuSettings;
exports.MenuTabs = MenuTabs;
exports.initialize = initialize;
exports.syncTabDisplay = syncTabDisplay;
//# sourceMappingURL=ix-menu-settings-CtWl0bME.js.map
