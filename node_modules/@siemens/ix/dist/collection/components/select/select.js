...
export class Select {
    ...
    renderChip(item) {
        return (h("ix-filter-chip", { disabled: this.disabled || this.readonly, key: item.value, onCloseClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.itemClick(item.value);
            } }, item.label));
    ...
    render() {
        var _a, _b, _c, _d;
        return (h(Host, { key: '1610cc7dd06025b8dc05cd905eb1fad5574a64f8', "aria-disabled": a11yBoolean(this.disabled), class: {
                disabled: this.disabled,
            } }, h("ix-field-wrapper", { key: '912ca0f6e59259ea7de5fbb4857357fcf1db8370', required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: '217ad54b9ca7a3e7aa9e60d89482b5fbc5389fc1', class: {
                select: true,
                disabled: this.disabled,
            ...
            } }, h("div", { key: '58d7051c6e884dc714643dcf974f7424b4581dfb', class: "input-container" }, h("div", { key: 'be6fec6f27345d8033b9b56ca3760c953951b801', class: "chips" }, this.isMultipleMode &&
            this.items.length !== 0 &&
            (this.shouldDisplayAllChip()
                ? this.renderAllChip()
                : (_a = this.selectedItems) === null || _a === void 0 ? void 0 : _a.map((item) => this.renderChip(item))), h("div", { key: 'a9b0c66c623856ab4b2c34f136bbef89a4b3377f', class: "trigger" }, h("input", { key: '1920a23f38ce924fae991be2b5c4a760031aae1f', autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
            ...
            !this.disabled &&
            !this.readonly &&
            (((_d = this.selectedLabels) === null || _d === void 0 ? void 0 : _d.length) || this.inputFilterText) ? (h("ix-icon-button", { key: "clear", class: "clear", icon: iconClear, variant: "subtle-tertiary", oval: true, size: "16", onClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.clear();
                ...
                if (this.editable)
                    this.dropdownWrapperRef(ref);
            }, "aria-label": this.ariaLabelChevronDownIconButton }))))))), h("ix-dropdown", { key: '4fcf2193ed3cc0faea0e5de7acab2835751c5583', ref: (ref) => (this.dropdownElement = ref), show: this.dropdownShow, closeBehavior: this.isMultipleMode ? 'outside' : 'both', class: {
            ...
            } }, h("div", { key: '428a499947d6f345a83d075d1749831d6b1ab348', class: {
                'select-list-header': true,
                hidden: this.hideListHeader || this.isDropdownEmpty,
            }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: '9bffa4284f53b45116dfff2f142fd2f4aea2032c', onSlotchange: () => {
                this.updateSelection();
            } }), h("div", { key: 'a039c9fda5d61358d39ae9cdc08df2fc82b55fa7', ref: (ref) => (this.customItemsContainerElement = ref) }), this.isAddItemVisible() ? (h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
                'add-item': true,
    ...
    static get properties() {
        return {
            ...
            "ariaLabelChevronDownIconButton": {
                "type": "string",
                "attribute": "aria-label-chevron-down-icon-button",
                "mutable": false,
                "complexType": {
                    "original": "string",
                    "resolved": "string | undefined",
                ...
                "docs": {
                    ...
                    "text": "ARIA label for the chevron down icon button\nWill be set as aria-label on the nested HTML button element"
                },
                "getter": false,
                "setter": false,
                "reflect": false,
                "defaultValue": "'Open select dropdown'"
            },
            ...
            "i18nPlaceholderEditable": {
                "type": "string",
                "attribute": "i18n-placeholder-editable",
                "mutable": false,
                "complexType": {
                    "original": "string",
                    "resolved": "string",
            ...
            "i18nSelectListHeader": {
                "type": "string",
                "attribute": "i18n-select-list-header",
                "mutable": false,
                "complexType": {
                    "original": "string",
                    "resolved": "string",
            ...
            "i18nAllSelected": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Chip label for all selected items in multiple mode."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "dropdownWidth": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The width of the dropdown element with value and unit (e.g. \"200px\" or \"12.5rem\")."
                },
                "getter": false,
                "setter": false,
                "reflect": false
            ...
            "dropdownMaxWidth": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The maximum width of the dropdown element with value and unit (e.g. \"200px\" or \"12.5rem\").\nBy default the maximum width of the dropdown element is set to 100%."
                },
                "getter": false,
                "setter": false,
                "reflect": false
            ...
            "collapseMultipleSelection": {
                "type": "boolean",
                "attribute": "collapse-multiple-selection",
                "mutable": false,
                "complexType": {
                    "original": "boolean",
                    "resolved": "boolean",
                ...
                "docs": {
                    "tags": [],
                    "text": "Show \"all\" chip when all items are selected in multiple mode"
                },
                "getter": false,
                "setter": false,
                "reflect": false,
    ...
    static get methods() {
        return {
            ...
            "isTouched": {
                ...
                "docs": {
                    "text": "Check if the input field has been touched.",
                    "tags": [{
                            "name": "internal",
                            "text": undefined
                        }]
