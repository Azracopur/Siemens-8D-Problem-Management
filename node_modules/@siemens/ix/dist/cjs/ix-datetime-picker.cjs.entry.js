...
const DatetimePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2b4812deec9408836a8187c3a520cd69b846e935' }, index.h("ix-layout-grid", { key: '610fad916eb544d6687bcbfb3543b926f7521b9e', class: "no-padding" }, index.h("ix-row", { key: '63dcab9421e05163577db32fda3bd714a0c00de7', class: "row-separator" }, index.h("ix-col", { key: '8ac25a8147b15ac20b45c3f1e48bfda34919eae1', class: "col-separator" }, index.h("ix-date-picker", { key: '1831729d8dcb31e5361fbef4a6290111847b8679', ref: (ref) => (this.datePickerElement = ref), corners: "left", singleSelection: this.singleSelection, onDateChange: (event) => this.onDateChange(event), from: this.from, to: this.to, format: this.dateFormat, minDate: this.minDate, maxDate: this.maxDate, weekStartIndex: this.weekStartIndex, embedded: true, locale: this.locale, showWeekNumbers: this.showWeekNumbers, ariaLabelPreviousMonthButton: this.ariaLabelPreviousMonthButton, ariaLabelNextMonthButton: this.ariaLabelNextMonthButton })), index.h("ix-col", { key: '51b004e4362c9dc26d0e59909cfb431fd874cbac' }, index.h("ix-time-picker", { key: '40672098b7e7cc369afd8429b34d14b97bcd1380', class: "min-width", ref: (ref) => (this.timePickerElement = ref), embedded: true, dateTimePickerAppearance: true, onTimeChange: (event) => this.onTimeChange(event), format: this.timeFormat, time: this.time }))), index.h("ix-row", { key: '876f3e8defe5de50013e8ea7e1f3465bd6e339a1' }, index.h("ix-col", { key: '1515e3e7b9ac5b121c8b0c3284092698f85652bf' }, index.h("div", { key: '6aa46d00d240c20de2e92bd5fa62f6ca59f53274', class: "btn-select-date-container" }, index.h("ix-button", { key: 'ca4e27ecc31600f97ac2ab061cbbf29b2c717078', class: "btn-select-date", onClick: () => this.onDone() }, this.i18nDone)))))));
    }
};
