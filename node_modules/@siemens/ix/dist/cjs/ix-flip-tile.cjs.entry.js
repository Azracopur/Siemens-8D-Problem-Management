...
const FlipTile = class {
    ...
    handleFooterSlotChange(event) {
        const { target } = event;
        const slot = target;
        this.hasFooterSlot = shadowDom.hasSlottedElements(slot);
    }
    updateContentItems() {
    ...
    doFlipAnimation(index) {
        ...
        anime_esm.animate(this.hostElement.shadowRoot.querySelector('.flip-tile-container'), {
            keyframes: {
                '0%': {
                    transform: 'rotateY(0)',
                },
        ...
        setTimeout(() => {
            this.isFlipAnimationActive = false;
        }, 2 * animation.Animation.defaultTime);
    }
    render() {
        return (index.h(index.Host, { key: '32727b4df750f9d1892f365a7e8d729447be05ac', class: {
            ...
            } }, index.h("div", { key: 'e58093dce55ede49f9f1782327c73918ee21d2c6', class: "flip-tile-container" }, index.h("div", { key: 'bd60e44b5b04177c4003936aa15d6539cd093883', class: "flip-tile-header" }, index.h("div", { key: '792d0e39b406fb50561f3c35c0340ee827b568e6', class: "header-slot-container text-l-title" }, index.h("slot", { key: '9e320aef9f89689b594c9555e154c8795dbdb233', name: "header" })), index.h("ix-icon-button", { key: 'dc0a042565001a79ea17e33671f4c2486b702ebf', icon: index$1.iconEye, variant: "tertiary", onClick: () => this.toggleIndex(), "aria-label": this.ariaLabelEyeIconButton })), index.h("div", { key: 'fa61544ccf0e16884c4d747e0e7cc174216d7906', class: "content-container" }, index.h("slot", { key: '1ed79120c3e926bb5f48a0e1980f5dfb785050f8' })), index.h("div", { key: '543216df0a9e93c9a739b921259e529eb494e751', class: {
                footer: true,
                'show-footer': this.hasFooterSlot,
            } }, index.h("slot", { key: '271f61fc236be2813cec900c788fe4bfcb2c285d', name: "footer", onSlotchange: (event) => this.handleFooterSlotChange(event) })))));
    }
