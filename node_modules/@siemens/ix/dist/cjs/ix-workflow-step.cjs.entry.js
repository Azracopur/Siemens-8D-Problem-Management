...
const WorkflowStep = class {
    ...
    getIconAriaLabel() {
        switch (this.iconName) {
            case index$1.iconCircle:
                return 'Circle';
            case index$1.iconCircleDot:
                return 'Circle dot';
            case index$1.iconCircleFilled:
                return 'Done';
            case index$1.iconError:
                return 'Error';
            case index$1.iconSuccess:
                return 'Success';
            case index$1.iconTriangleFilled:
                return 'Warning';
            case index$1.iconWarning:
                return 'Warning';
            default:
                return 'Step';
        }
    ...
    render() {
        const icons = !this.customIconSlot ? (index.h(index.Fragment, null, index.h("ix-icon", { color: "color-1", name: this.status === 'warning' ? index$1.iconTriangleFilled : index$1.iconCircleFilled, class: "absolute", size: "24" }), index.h("ix-icon", { color: this.iconColor, name: this.iconName, class: "absolute", size: "24", "aria-label": this.getIconAriaLabel() }))) : null;
        return (index.h(index.Host, { key: '69060f0b0d9724d1a7e5d88d723454354a0ae179', class: { 'host-vertical': this.vertical }, onClick: () => this.onStepClick() }, index.h("div", { key: 'e271713f7b57462155e967d2fd74bb911640c6b1', tabIndex: 0, class: {
                step: true,
                selected: this.selected,
                vertical: this.vertical,
                disabled: this.disabled,
                clickable: this.clickable && !this.disabled,
            } }, index.h("div", { key: '28fb3c2e870564f3cfa62a402ba75b62ef84d68f', class: "wrapper" }, index.h("div", { key: '7178b44d0f6e20202c62e83af8e983392cf00ecd', class: {
                line: true,
                selected: this.selected,
                [this.status]: true,
                [this.position]: true,
            } }), index.h("div", { key: '8f10884a92e4f0685f20a10cb12cd19b39a7a2f9', class: "iconWrapper" }, icons, index.h("slot", { key: '6e3d96ae17ce0b3b217edef59b1e3999a1d028d5', name: "custom-icon" }))), index.h("div", { key: '80b1b2adc4f110d505e5fcb4263781b11b58ff49', class: "text" }, index.h("slot", { key: '07f9b88ce66abffd1190940968ed20ae6cd5ec09' })))));
    }
...
//# sourceMappingURL=ix-workflow-step.entry.cjs.js.map
