...
const Select = /*@__PURE__*/ proxyCustomElement(class Select extends H {
    ...
    static get style() { return selectCss; }
        ...
        "required": [516],
        "label": [1],
        "ariaLabelChevronDownIconButton": [1, "aria-label-chevron-down-icon-button"],
