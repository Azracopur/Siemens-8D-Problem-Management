...
const Radio = class {
    ...
    connectedCallback() {
        ...
        if (parent) {
            this.classMutationObserver = validation.createClassMutationObserver(parent, () => {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0a08dcbeaaf21bb9063ff44dbb9b7fec0bd18b85', "aria-checked": a11y.a11yBoolean(this.checked), "aria-disabled": a11y.a11yBoolean(this.disabled), role: "radio", tabindex: tabIndex, class: {
                ...
                if (this.disabled)
                    return;
                this.setCheckedState(true);
            }, onKeyDown: (event) => this.onKeyDown(event), onBlur: () => this.ixBlur.emit() }, index.h("label", { key: 'ba82e05023a706e366cede669060ec11d2848754' }, index.h("div", { key: 'c3b75eea221618adc27dec099089dac0f84a91ac', class: "radio-button" }, index.h("div", { key: 'd5d10cfce1442f641f939aa16a6feb79fc38caf0', "aria-hidden": "true", class: {
                ['radio-checkmark']: true,
                checked: this.checked,
            } }, index.h("div", { key: 'fe7c6830a7fb254291fe95d4310b59bd32ed9492', class: "checkmark", style: { visibility: this.checked ? 'visible' : 'hidden' } }))), this.label && (index.h("ix-typography", { key: 'bc5fe1821b5686760eb7fa3959cf30b54cca40ee', format: "label", textColor: this.disabled ? 'weak' : 'std' }, this.label, index.h("slot", { key: 'a72b3d10cdcbaa398a6f59b9ce1d036f12e4819c' }))))));
    }
...
exports.ix_radio = Radio;
//# sourceMappingURL=ix-radio.entry.cjs.js.map
