...
export declare function isTouched<T>(host: IxFormComponent<T>): Promise<boolean | undefined>;
...
export declare function getValidationText(isInputInvalid: boolean, customInvalidText: string | undefined, i18nFallbackText: string): string | undefined;
