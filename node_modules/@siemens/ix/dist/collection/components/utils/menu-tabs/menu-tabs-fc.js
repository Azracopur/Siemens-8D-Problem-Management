...
export const MenuTabs = ({ context }) => {
    ...
    return (h(Host, { slot: context instanceof MenuSettings ? 'ix-menu-settings' : 'ix-menu-about', class: {
            show: context.show,
        } }, h("div", { class: context instanceof MenuSettings ? 'settings-header' : 'about-header' }, h("h2", { class: "text-h2" }, context.label), h("ix-icon-button", { variant: "tertiary", size: "24", icon: iconClose, iconColor: "color-soft-text", onClick: (e) => context.close.emit({
