...
declare class ThemeSwitcher {
    ...
    private handleClassMutations;
    private handleDataMutations;
    private registerMutationObservers;
    constructor();
}
export type IxTheme = LiteralStringUnion<'classic' | 'classic-dark' | 'classic-light'>;
