...
const ApplicationHeader = class {
    ...
    checkLogoSlot() {
        ...
        if (isSiemensLogoDefined) {
            return shadowDom.hasSlottedElements(slotElement);
        }
    ...
    updateHasSlotAssignedElementsStates() {
        ...
        this.hasDefaultSlotElements = shadowDom.hasSlottedElements(defaultSlot);
        this.hasSecondarySlotElements = shadowDom.hasSlottedElements(secondarySlot);
        this.hasOverflowSlotElements = shadowDom.hasSlottedElements(overflowSlot);
