...
const Toast = class {
    ...
    getIcon() {
        if (this.icon) {
            return (index.h("ix-icon", { "data-testid": "toast-icon", name: this.icon, color: this.iconColor, size: "24" }));
        }
        switch (this.type) {
            case 'info':
                return (index.h("ix-icon", { "data-testid": "toast-icon", name: index$1.iconInfo, size: "24", color: "color-std-text" }));
            case 'error':
                return (index.h("ix-icon", { "data-testid": "toast-icon", name: index$1.iconError, size: "24", color: "color-alarm" }));
            case 'success':
                return (index.h("ix-icon", { "data-testid": "toast-icon", name: index$1.iconSuccess, size: "24", color: "color-success" }));
            case 'warning':
                //TODO(IX-3400): Replace icon colors with proper CSS variables when available
                return (index.h("ix-icon", { "data-testid": "toast-icon", name: index$1.iconWarning, size: "24", color: "color-warning-text" }));
            default:
                return '';
        }
    }
...
//# sourceMappingURL=ix-toast.entry.cjs.js.map
