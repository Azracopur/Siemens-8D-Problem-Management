...
var baseIconButton = require('./base-icon-button-D3kZg-im.js');
var a11y = require('./a11y-B_6chCvu.js');
require('./base-button-CjsUotrL.js');
...
const IconButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '04486b7d26d2b34a920b53f683b3b1b591b95311', class: Object.assign(Object.assign({}, this.getIconSizeClass()), { disabled: this.disabled || this.loading }) }, index.h(baseIconButton.BaseIconButton, Object.assign({ key: '94936955261d6fc13e78ea98ddb3cf98d3fda058' }, baseButtonProps))));
    }
...
const Spinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6f99a58994e1eb03a05b6af195b843094ebea59b' }, index.h("div", { key: '01ff7d8f23eb80440970086c8791471623cfe424', class: {
