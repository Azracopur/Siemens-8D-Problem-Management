...
export class DateInput {
    ...
    static get properties() {
        return {
            ...
            "minDate": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The earliest date that can be selected by the date input/picker.\nIf not set there will be no restriction."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "maxDate": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The latest date that can be selected by the date input/picker.\nIf not set there will be no restriction."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "ariaLabelCalendarButton": {
                "type": "string",
                "attribute": "aria-label-calendar-button",
                "mutable": false,
                "complexType": {
                    "original": "string",
                    "resolved": "string | undefined",
                ...
                "docs": {
                    ...
                    "text": "ARIA label for the calendar icon button\nWill be set as aria-label on the nested HTML button element"
                },
                "getter": false,
                "setter": false,
                "reflect": false
            ...
            "textAlignment": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Text alignment within the date input. 'start' aligns the text to the start of the input, 'end' aligns the text to the end of the input."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
                ...
                "complexType": {
                    ...
                    "references": {
                        "DateInputValidityState": {
                            "location": "import",
                            "path": "./date-input.types",
                            "id": "src/components/date-input/date-input.types.ts::DateInputValidityState"
                        }
                    }
                }
            }, {
    ...
    static get watchers() {
        return [{
                "propName": "value",
                "methodName": "watchValuePropHandler"
            }, {
                "propName": "value",
