...
const Upload = class {
    ...
    renderUploadState() {
        ...
        switch (this.state) {
            ...
            case uploadFileState.UploadFileState.UPLOAD_FAILED:
                return (index.h("span", { class: "state" }, index.h("ix-icon", { name: index$1.iconError, class: "icon-error" }), index.h("span", { class: "upload-text" }, this.uploadFailedText)));
            case uploadFileState.UploadFileState.UPLOAD_SUCCESSED:
                return (index.h("span", { class: "state" }, index.h("ix-icon", { name: index$1.iconSuccess, class: "icon-success" }), index.h("span", { class: "upload-text" }, this.uploadSuccessText)));
            default:
                return '';
        }
    }
    ...
    render() {
        const disabled = this.disabled || this.state === uploadFileState.UploadFileState.LOADING;
        const _a = this.a11y, { 'aria-label': ariaLabel = 'Upload files' } = _a, a11y = __rest(_a, ['aria-label']);
        return (index.h(index.Host, Object.assign({ key: '8b8c68a23b429ca57854751c8a1c9358f78cbc9f' }, a11y, { "aria-disabled": disabled }), index.h("div", { key: '1bb186087ab0d5c545a3f183ce3f6de033a837ad', class: {
            ...
            }, onDragOver: (e) => this.fileOver(e), onDragLeave: () => this.fileLeave(), draggable: !this.disabled }, this.renderUploadState(), index.h("div", { key: '52209f325ad967197e48f651cc6f15365be9562f' }, index.h("input", { key: '91c11214c2f169a9dfbeaaac88a7d928ab389455', "aria-label": ariaLabel, "aria-disabled": disabled, multiple: this.multiple, type: "file", class: "upload-browser", id: "upload-browser", tabindex: "-1", onChange: (e) => {
                this.fileChangeEvent(e);
            }, accept: this.accept, disabled: disabled }), index.h("ix-button", { key: '807022699c0ba9ac3d81557e88cf1ae498a36cca', variant: "secondary", "aria-disabled": disabled, onClick: () => this.inputElement.click(), disabled: disabled }, this.i18nUploadFile)))));
    }
...
//# sourceMappingURL=ix-upload.entry.cjs.js.map
