...
import type { DateTimeDateChangeEvent, DateTimeSelectEvent } from './datetime-picker.types';
export declare class DatetimePicker implements Omit<IxDatePickerComponent, 'corners' | 'format'> {
    /**
