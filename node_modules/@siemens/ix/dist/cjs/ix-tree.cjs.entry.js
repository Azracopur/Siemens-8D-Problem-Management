...
const Tree = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ca0d582877d3b2877a1090cc0aeb40f38617cef9', onClick: (event) => this.onTreeItemClick(event) }, index.h("slot", { key: '2d8f21165234243b6d2e2f7c99696fc7343d79f2' })));
    }
