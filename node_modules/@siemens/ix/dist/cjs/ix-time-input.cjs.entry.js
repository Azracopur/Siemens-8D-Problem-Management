...
require('./dropdown-controller-BLOjtc6w.js');
...
const TimeInput = class {
    ...
    onTimeIconClick(event) {
        pickerInput_util.handleIconClick(event, this.show, () => this.openDropdown(), this.inputElementRef);
    }
    async openDropdown() {
        // keep picker in sync with input
        this.time = this.value;
        return pickerInput_util.openDropdown(this.dropdownElementRef);
    }
    async closeDropdown() {
        return pickerInput_util.closeDropdown(this.dropdownElementRef);
    }
    checkClassList() {
    ...
    /** @internal */
    getValidityState() {
        return Promise.resolve(pickerInput_util.createValidityState(this.isInputInvalid, !!this.required, this.value));
    }
    /**
    ...
    render() {
        var _a;
        const invalidText = validation.getValidationText(this.isInputInvalid, this.invalidText, this.i18nErrorTimeUnparsable);
        return (index.h(index.Host, { key: 'aff9b793fae69ba2eb713ae3b1bd2222b548fb25', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, index.h("ix-field-wrapper", { key: '5e927fa4c2eeb94dba26b1f4ad1879a6a80ed823', label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText: invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), index.h("ix-dropdown", { key: '0b48b3c8574b0aafe42db74c990f1d269037bd82', "data-testid": "time-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
                this.show = event.detail;
            } }, index.h("ix-time-picker", { key: 'b3b5536c702fc45c9fc5f323282149c2c2ccb542', ref: this.timePickerRef, format: this.format, time: (_a = this.time) !== null && _a !== void 0 ? _a : '', hourInterval: this.hourInterval, minuteInterval: this.minuteInterval, secondInterval: this.secondInterval, millisecondInterval: this.millisecondInterval, embedded: true, hideHeader: this.hideHeader, i18nConfirmTime: this.i18nSelectTime, i18nHeader: this.i18nTime, i18nHourColumnHeader: this.i18nHourColumnHeader, i18nSecondColumnHeader: this.i18nSecondColumnHeader, i18nMinuteColumnHeader: this.i18nMinuteColumnHeader, i18nMillisecondColumnHeader: this.i18nMillisecondColumnHeader, onTimeSelect: (event) => {
