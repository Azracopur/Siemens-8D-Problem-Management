...
const CardAccordion = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dc1b41f8878a1aa87869d11829c9a3cc218ca12e', slot: "card-accordion", class: {
                [`variant-${this.variant}`]: true,
            } }, index.h("button", { key: '0fc447aadb0c86405700f00c18d17be887eef3fb', tabIndex: 0, class: { 'expand-action': true, show: this.expandContent }, onClick: (event) => this.onExpandActionClick(event), role: "button", type: "button", "aria-expanded": this.expandContent, "aria-controls": getAriaControlsId(), "aria-label": this.ariaLabelExpandButton }, index.h("ix-icon", { key: 'b044d6c5c9561355750483c29824bfe27af75db5', name: index$1.iconChevronDownSmall, class: {
                'expand-icon': true,
                show: this.expandContent,
            } })), index.h("div", { key: 'df7c48aaa25ad38136479fb972ffe0776efa0ae3', class: {
                'expand-content': true,
                show: this.expandContent,
            } }, index.h("div", { key: '9f9bd7ef6d674f0d6561ac9c237443062eec9693', class: "expand-content-inner" }, index.h("div", { key: '1576b901ba50a5ec7e765ae64e8cd6acba047973', class: "expand-content-body" }, index.h("slot", { key: 'ef118ded7d20ba6dd70c45a0d34f86a89959e69c' })), index.h("div", { key: '248e9c925bf36e9598386a78562abd8a3db77c06', class: "expand-content-footer" })))));
    }
...
const CardHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a25925e3092733c276c366875802163184f79a2b' }, index.h("slot", { key: 'c379e97f4966141ac879c9df014f793955d1d2f3' }), index.h("div", { key: '5ea530ca1110748ed53b7b0724d5ec0920194628', class: "title-actions" }, index.h("slot", { key: '10f91158d202b321c21d07dda30ff7e59999aaa9', name: "title-actions" }))));
    }
};
