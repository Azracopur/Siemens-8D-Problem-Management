...
const EventListItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '76e06ddd63da8e0adec50dcd20bc61e2f2d1e1c0', class: {
                disabled: this.disabled,
                [`event-list-item-${this.variant}`]: true,
            } }, index.h("div", { key: 'b04e600de4ca8f82c0ac973f6df2efc6a9c1acdb', role: "listitem", "aria-disabled": a11y.a11yBoolean(this.disabled), class: {
                'event-list-item': true,
                selected: this.selected,
                disabled: this.disabled,
            } }, index.h("div", { key: 'e8cbc3d3a7e752fd60fa30b92503d4c7a2b64392', class: `indicator ${!this.itemColor ? 'indicator-empty' : ''}`, style: {
                'background-color': this.itemColor ? color : 'inherit',
                opacity: `${this.disabled ? 0.4 : 1}`,
            } }), index.h("div", { key: '41e137395c4466be016fd1c97456b040f60de4ab', class: "event-list-item-container" }, index.h("div", { key: '0a38f7c6f62b877dde4a27db021daff4c47440e0', class: "event-content" }, index.h("slot", { key: '8867732a5801ab78afc2de8ff60a715608c5f8c7' })), this.chevron && (index.h("ix-icon", { key: '3a0155d4a8dc6fae7d65c181f0197abe5f78b4af', name: index$1.iconChevronRight, size: "16", class: "chevron-icon", "aria-hidden": "true" }))))));
    }
};
