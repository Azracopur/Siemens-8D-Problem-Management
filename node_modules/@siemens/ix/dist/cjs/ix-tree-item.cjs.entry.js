...
const TreeItem = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '52817f9eed914ee6b01b67848af3f7073f21d65c', class: {
                selected: !!((_a = this.context) === null || _a === void 0 ? void 0 : _a.isSelected),
            } }, index.h("div", { key: '95b40939dac08653e875985a160e5aa45ebc353c', class: "icon-toggle-container" }, this.hasChildren ? (index.h("ix-icon", { name: index$1.iconChevronRightSmall, size: "24", class: {
                ['icon-toggle-down']: !!((_b = this.context) === null || _b === void 0 ? void 0 : _b.isExpanded),
            }, color: "color-std-text", onClick: (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.toggle.emit();
            }, "aria-label": this.ariaLabelChevronIcon })) : null), index.h("div", { key: '656eda787f5fbf263ced33629d3ebde110c3f917', class: "tree-node-container", onClick: () => {
                this.itemClick.emit();
            } }, index.h("div", { key: 'eba55e54bf655fc0c3d0aacbfc3cb7e49fcb13f6', class: "tree-node-text" }, this.text), index.h("slot", { key: '4747766e632c2bdf7865b25b8d2abf82405c57c8' }))));
    }
};
