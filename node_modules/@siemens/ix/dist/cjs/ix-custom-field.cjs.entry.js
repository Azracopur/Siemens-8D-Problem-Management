...
const CustomField = class {
    ...
    render() {
        return (index.h(index.Host, { key: '732dae3e5ba3f37b5eac745ce48338cae5397d9e' }, index.h("ix-field-wrapper", { key: '5df555252c2de619f3dd5daa082632695a88e3f6', label: this.label, helperText: this.helperText, infoText: this.infoText, warningText: this.warningText, invalidText: this.invalidText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, required: this.required }, index.h("slot", { key: '81d169fce11d76b04876eb3483909bf163c44370' }))));
    }
...
exports.ix_custom_field = CustomField;
//# sourceMappingURL=ix-custom-field.entry.cjs.js.map
